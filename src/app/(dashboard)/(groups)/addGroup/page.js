    ...
    return ( <div>
        ...
        <form onSubmit={(e)=>{
          ...
          addGroup(data).then((dat)=>{
            ...
            <h1 className="text-2xl font-medium text-slate-800 mb-4">New church group</h1>
            <div className="grid grid-cols-1 gap-4">
               ...
               <FormGroup label="Group type" 
                inputField={<select name="type" className="border text-base w-3/5 py-1  border-slate-300 rounded-lg"
               >
