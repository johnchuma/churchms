    ...
    return ( <div>
        ...
        <form onSubmit={(e)=>{
          ...
          addMember(data).then((dat)=>{
            ...
            <h1 className="text-2xl font-medium text-slate-800 mb-4">New church member</h1>
            <div className="grid grid-cols-1 gap-4">
               ...
               <FormGroup label="Phone number" 
                inputField={<input name="phone" required type="number" className="border text-base w-3/5 py-1  border-slate-300 rounded-lg"
                placeholder="Enter phone number" />}/>
               <FormGroup label="Address" 
                inputField={<input name="address" required className="border text-base w-3/5 py-1  border-slate-300 rounded-lg"
               ...
               <FormGroup label="Gender" 
                inputField={<select name="gender" className="border text-base w-3/5 py-1  border-slate-300 rounded-lg"
                placeholder="Select gender" >
                    <option value="Male">Male</option>
                    <option value="Female">Female</option>
                </select>}/>
               <FormGroup label="Work status" 
                inputField={<select name="work" className="border text-base w-3/5 py-1  border-slate-300 rounded-lg" >
               ...
               <FormGroup label="Any disablity" 
                inputField={<input name="disability" className="border text-base w-3/5 py-1  border-slate-300 rounded-lg"
                placeholder="Mention if member has any disability" />}/>
                <FormGroup label="Maritial status" 
                inputField={<select name="maritialStatus" className="border text-base w-3/5 py-1  border-slate-300 rounded-lg" >
               ...
               <FormGroup label="Is house owner ?" 
                inputField={
                <select name="isHouseOwner" className="border text-base w-3/5 py-1  border-slate-300 rounded-lg" >
                <option value={false}>No</option>
                <option value={true}>Yes</option>
            </select>}/>
            <FormGroup label="Is baptised ?" 
                inputField={
                <select name="isBaptised" className="border text-base w-3/5 py-1  border-slate-300 rounded-lg" >
                <option value={false}>No</option>
                <option value={true}>Yes</option>
            </select>}/>
            </div>
