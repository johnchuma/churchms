    ...
    return ( <div>
...

        {
             ...
             <div className="flex justify-end">
                <input className="border-slate-700 rounded-lg py-1 text-base "  onChange={(e)=>{
             ...
             <table className="min-w-full  ">
                 <thead className="font-medium border-b border-slate-200 py-3 ">
                     ...
                     <th className="text-start py-2 text-base text-slate-900 font-medium">Scriptures</th>
                     <th className="text-start py-2 text-base text-slate-900 font-medium">Introduction</th>          
